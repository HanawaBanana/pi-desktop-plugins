...
How to deepen a cluster of shallow modules safely, given its dependencies. Assumes the vocabulary in [SKILL.md](codebase-design.md): **module**, **interface**, **seam**, **adapter**.
